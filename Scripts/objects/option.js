...
(function (objects) {
    ...
    var Option = (function (_super) {
         ...
         */
        function Option(imageString, x, y, isCentered) {
         ...
         */
        Option.prototype._mouseOver = function (event) {
            //this.alpha = 0.7;
            //this.getBounds().width = 220;
            //this.getBounds().width = 220;
            this.filters = [
         ...
         * @param {createjs.MouseEvent} event
         */
        Option.prototype._mouseOut = function (event) {
            //this.alpha = 1.0;
            //this.getBounds().width = 100;
            //this.getBounds().width = 100;
            this.filters = [];
            this.updateCache();
        ...
        Option.prototype.get_tip = function () {
            var str = this.name;
            if (str.indexOf('_') >= 0) {
        ...
        Option.prototype.getVariableName = function (name) {
