...
(function (core) {
    ...
    function init() {
        ...
        core.countryAtlas = new createjs.SpriteSheet(countryData);
        core.veggiesAtlas = new createjs.SpriteSheet(veggieData);
        core.buttonAtlas = new createjs.SpriteSheet(buttonData);
        // setup the default scene
        core.scene = config.Scenes_game[0];
        changeMenuScene();
    }
    /**
    ...
    function changeMenuScene() {
        ...
        switch (core.scene) {
            case config.Scenes_game[0]:
                transition(new question_scenes.MenuScene());
                break;
            case config.Scenes_game[1]:
                transition(new basil_scenes.Plant_scene());
                break;
    ...
    core.changeMenuScene = changeMenuScene;
    function changeBasilScene() {
        //Launch Various Scenes
        switch (core.scene) {
            case config.Scenes_game[0]:
                transition(new question_scenes.MenuScene());
                break;
            case config.Basil_scenes[0]:
                transition(new basil_scenes.Plant_scene());
                break;
            case config.Basil_scenes[1]:
                transition(new basil_scenes.Second_Step());
                break;
            case config.Basil_scenes[2]:
                transition(new basil_scenes.Third_Step());
                break;
            case config.Basil_scenes[4]:
                transition(new basil_scenes.Fourth_Step());
                break;
            case "DEAD":
                transition(new basil_scenes.Dead());
                break;
            case "BAD":
                transition(new basil_scenes.Bad());
                break;
            case "PERFECT":
                transition(new basil_scenes.Perfect());
                break;
        }
    }
    core.changeBasilScene = changeBasilScene;
